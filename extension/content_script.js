...
// Some websites like nascar reload this script again and again. But it most of the time does not create a problem.
...
chrome.runtime.onMessage.addListener( function(request, sender, sendResponse) {
    ...
    if (request.message === "sending_links") {
        ...
        let csv_downloadLinks_ = downloadLinks_and_tableIndices.csv_download_links;
        let excel_downloadLinks_ = downloadLinks_and_tableIndices.excel_download_links;
        let tableIndices_ = downloadLinks_and_tableIndices.table_indices;

        highlight_tables_and_show_download_links(tableIndices_, csv_downloadLinks_, excel_downloadLinks_);
        ...
        clickListener = (event) => {
            ...
            html2canvas(screenshotTarget).then((canvas) => {
                ...
                */
                ...
                let data_to_send = JSON.stringify({ 'screenshot': base64image, 'session_id': request.session_id_});
...
function highlight_tables_and_show_download_links(tableIndices, csv_downloadLinks, excel_downloadLinks){
   // Give green borders to caught tables, also add a title with download link
    ...
    for (let i=0; i < tableIndices.length ; i++){
        ...
        csv_download_link.classList.add("already_created_");
        csv_download_link.href = csv_downloadLinks[i];
        csv_download_link.target = "_blank";
        csv_download_link.style["margin-right"] = "30px";
        csv_download_link.style["text-decoration"] = "none";

        let excel_download_link = document.createElement("a");
        excel_download_link.classList.add("already_created_");
        excel_download_link.href = excel_downloadLinks[i];
        excel_download_link.target = "_blank";
        excel_download_link.style["text-decoration"] = "none";

        const csv_download_title = document.createElement("h3");
        csv_download_title.style["color"] = "green";
        csv_download_title.style["text-align"] = "right";
        csv_download_title.style["margin-bottom"] = "30px";
        csv_download_title.style["font-size"] = "23px";
        csv_download_title.style["margin-right"] = "5%";
        csv_download_title.style["width"] = "100%";
        const csv_textNode = document.createTextNode("Table " + (i+1) + " CSV");
        csv_download_title.appendChild(csv_textNode);

        const excel_download_title = document.createElement("h3");
        excel_download_title.style["color"] = "green";
        excel_download_title.style["text-align"] = "right";
        excel_download_title.style["margin-bottom"] = "30px";
        excel_download_title.style["font-size"] = "23px";
        excel_download_title.style["margin-right"] = "5%";
        excel_download_title.style["width"] = "100%";
        const excel_textNode = document.createTextNode("Table " + (i+1) + " Excel");
        excel_download_title.appendChild(excel_textNode);

        let download_icon_1 = document.createElement('img');
        let download_icon_2 = document.createElement('img');
        ...
        download_icon_1.src = "data:image/png;base64,";
        download_icon_2.src = "data:image/png;base64,";
        download_icon_1.style.height = "1em";
        download_icon_2.style.height = "1em";
        download_icon_1.style["margin-left"] = "10px";
        download_icon_2.style["margin-left"] = "10px";


        csv_download_title.appendChild(download_icon_1);
        excel_download_title.appendChild(download_icon_2);

        csv_download_link.appendChild(csv_download_title);
        excel_download_link.appendChild(excel_download_title);

        let download_buttons = document.createElement('div');
        download_buttons.style["margin-right"] = "5%";
        download_buttons.style["display"] = "flex";
        download_buttons.style["justify-content"] = "center";


        download_buttons.appendChild(csv_download_link);
        download_buttons.appendChild(excel_download_link);

        tables[i].parentElement.insertBefore(download_buttons, tables[i]);
    }
